...
function memoize(func) {
  ...
  return (...arg) => {
    if (singleResult.has(func)) return singleResult.get(func);
    singleResult.set(func, func(...arg));
    return singleResult.get(func);
  };
}
